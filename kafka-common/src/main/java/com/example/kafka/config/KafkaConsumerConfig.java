...
public class KafkaConsumerConfig {
  ...
  @Bean
  public ConsumerFactory<String, Long> consumerFactory(KafkaSettings kafkaSettings) {
  ...
  @Bean
  public KafkaConsumerFactoryWrapper kafkaConsumer(ConsumerFactory<String, Long> consumerFactory) {
