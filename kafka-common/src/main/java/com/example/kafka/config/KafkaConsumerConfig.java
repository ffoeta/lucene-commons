...
public class KafkaConsumerConfig {
  ...
  @Bean
  public ConsumerFactory<String, KafkaMessage> consumerFactory(KafkaSettings kafkaSettings) {
  ...
  @Bean
  public KafkaConsumerFactoryWrapper kafkaConsumer(ConsumerFactory<String, KafkaMessage> consumerFactory) {
    return new KafkaConsumerFactoryWrapper(consumerFactory);
  }
}
